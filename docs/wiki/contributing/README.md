...
* First, ensure that you're running the [latest stable version](https://github.com/AzorianSolutions/kea-ha/releases) of Kea-HA. If you're running an older version, there's a chance that the bug has already been fixed.

* Next, search our [issues list](https://github.com/AzorianSolutions/kea-ha/issues?q=is%3Aissue) to see if the bug you've found has already been reported. If you come across a bug report that seems to match, please click "add a reaction" in the top right corner of the issue and add a thumbs up (:thumbsup:). This will help draw more attention to it. Any comments you can add to provide additional information or context would also be much appreciated.

* If you can't find any existing issues (open or closed) that seem to match yours, you're welcome to
[submit a new bug report](https://github.com/AzorianSolutions/kea-ha/issues/new?assignees=&labels=bug+%2F+broken-feature&template=bug_report.yaml).
...
[Labeling Standards](https://github.com/AzorianSolutions/kea-ha/blob/main/docs/wiki/contributing/labeling-standards.md).

### :bulb: Feature Requests

* First, check the GitHub [issues list](https://github.com/AzorianSolutions/kea-ha/issues?q=is%3Aissue) to see if the feature you have in mind has already been proposed. If you happen to find an open feature request that matches your idea, click "add a reaction" in the top right corner of the issue and add a thumbs up (:thumbsup:). This ensures that the issue has a better chance of receiving attention. Also feel free to add a comment with any additional justification for the feature.

* If you have a rough idea that's not quite ready for formal submission yet, start a [GitHub discussion](https://github.com/AzorianSolutions/kea-ha/discussions) instead. This is a great way to test the viability and narrow down the scope of a new feature prior to submitting a formal proposal, and can serve to generate interest in your idea from other community members.

* Once you're ready, submit a feature request [using this template](https://github.com/AzorianSolutions/kea-ha/issues/new?assignees=&labels=feature+%2F+request&template=feature_request.yaml). Be sure to provide sufficient context and detail to convey exactly what you're proposing and why. The stronger your use case, the better chance your proposal has of being accepted.
...
* [Pull requests](https://docs.github.com/en/pull-requests) (a feature of GitHub) are used to propose changes to Kea-HA's code base. Our process generally goes like this:
...
We're always looking for motivated individuals to join the maintainers team and help drive Kea-HA's long-term development. Some of our most sought-after skills include:

* Bash / Shell scripting experience specifically with developing automation tooling
* Python development with a strong focus on frameworks like [Django](https://www.djangoproject.com/), [FastAPI](https://fastapi.tiangolo.com/), and [Pydantic](https://pydantic.dev/)
* Expertise working with DNS services, DHCP services, MySQL, and/or PostgreSQL databases
* Familiarity with git and software development best practices
* Excellent attention to detail
* Working experience in the field of network operations as it relates to the use of DNS (Domain Name System) and DHCP (Dynamic Host Configuration Protocol) servers.
...
Some maintainers petition their employer to grant some of their paid time to work on Kea-HA.

Interested? You can contact our lead maintainer, Matt Scott, at help@azorian.solutions. We'd love to have you on the team!

### :heart: Other Ways to Contribute

You don't have to be a developer to contribute to Kea-HA: There are plenty of other ways you can add value to the community! Below are just a few examples:

* Help answer questions and provide feedback in our [GitHub discussions](https://github.com/AzorianSolutions/kea-ha/discussions).
* Write a blog article or record a YouTube video demonstrating how Kea-HA is used at your organization.
